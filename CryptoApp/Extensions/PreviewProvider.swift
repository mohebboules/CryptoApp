...
// Can't be applied do to usage of Preview Macro instead of preview provider, if PreviewProvider was used:
/*
...
class DeveloperPreview {
    ...
    let stat3 = StatisticModel(title: "Portfolio calue", value: "$50.4K", percentageChange: -12.34)
